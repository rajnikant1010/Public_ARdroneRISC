...
K_way           = np.matrix([[   .2,    0,    0,  .34,    0,    0, 0],\
                             ...
                             [    0,    0, -.6,    0,    0, -6.6, 0],\
                             [    0,    0,    0,    0,    0,    0, 1]])
#K_slf8          = np.matrix([[ 1.8431,    0,    0, 1.9215,    0,    0, 0],\
#                             [    0, 1.6968,    0,    0, 1.8049,    0, 0],\
#                             [    0,    0, 1.8730,    0,    0, 0.5, 0],\
#                             [    0,    0,    0,    0,    0,    0, 1.043]])
#K_flf8          = np.matrix([[ 1.8431,    0,    0, 1.9215,    0,    0, 0],\
#                             [    0, 1.6968,    0,    0, 1.8049,    0, 0],\
#                             [    0,    0, 1.8730,    0,    0, 0.5, 0],\
#                             [    0,    0,    0,    0,    0,    0, 1.043]])
...
K_flf8          = np.matrix([[  .27,    0,    0, .7,    0,    0, 0],\
                             ...
                             [    0,    0,  -.6,    0,    0, -6.6, 0],\
                             [    0,    0,    0,    0,    0,    0, 1]])
#K_crcl          = np.matrix([[ 1.8431,    0,    0, 1.9215,    0,    0, 0],\
#                             [    0, 1.6401,    0,    0, 1.5,    0, 0],\
#                             [    0,    0, 1.8730,    0,    0, 0.4, 0],\
#                             [    0,    0,    0,    0,    0,    0, 1.043]])
#K_crcl          = np.matrix([[2, 0, 0, 2.2361, 0, 0, 0],[0, 2, 0, 0, 2.2361, 0, 0],[ 0, 0, -2, 0, 0, -2.0025, 0],[0, 0, 0, 0, 0, 0, 1]])/10
#K_crcl          = np.matrix([[0.27, 0, 0, 0.7, 0, 0, 0],[0, 0.27, 0, 0, 0.7, 0, 0],[ 0, 0, -0.6, 0, 0, -6.6, 0],[0, 0, 0, 0, 0, 0, 1]])
#K_crcl          = np.matrix([[ 3.8431, 0, 0, 3.9215, 0, 0, 0],[0, 3.6401, 0, 0, 4.5, 0, 0],[0, 0, -3.8730, 0, 0, -0.4, 0],[0, 0, 0, 0, 0, 0, 1.043]])*0.1

K_crcl          = np.matrix([[0.45, 0, 0, 0.45, 0, 0, 0],[0, 0.45, 0, 0, 0.45, 0, 0],[ 0, 0, -0.6, 0, 0, -6.6, 0],[0, 0, 0, 0, 0, 0, 1]])
