...
def getColumns(t, msg, imageFile = ""):
    ...
    if (msgType == '_sensor_msgs__LaserScan'):
        ...
        columns = [t, msg.header.seq, msg.header.stamp.secs, msg.header.stamp.nsecs,  msg.Obj[0].name, msg.Obj[0].phi, msg.Obj[0].theta,msg.Obj[0].psi,msg.Obj[0].alt]
## two quads
    elif (msgType == '_risc_msgs__Cortex'):
        columns = [t, msg.header.seq, msg.header.stamp.secs, msg.header.stamp.nsecs,  msg.Obj[0].name, msg.Obj[0].visible,msg.Obj[0].x,  msg.Obj[0].y, msg.Obj[0].z, msg.Obj[0].u, msg.Obj[0].v, msg.Obj[0].w, msg.Obj[0].phi, msg.Obj[0].theta,msg.Obj[0].psi,msg.Obj[0].p, msg.Obj[0].q, msg.Obj[0].r]
